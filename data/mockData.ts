...
export const mockProducts: Product[] = [
  {
    ...
    description: 'Kimono oficial da academia, confeccionado em tecido de alta qualidade com bordados exclusivos.',
    price: 89.90,
    ...
    images: [
      ...
      'https://images.pexels.com/photos/7045714/pexels-photo-7045714.jpeg'
    ],
    inStock: true,
    stockQuantity: 25,
    sizes: ['P', 'M', 'G', 'GG'],
  ...
  },
  {
    ...
    description: 'Luvas profissionais para treinamento de boxe e Krav Maga, com proteção superior.',
    price: 129.90,
  ...
  },
  {
    id: '3',
    name: 'Protetor Bucal',
    description: 'Protetor bucal moldável para máxima proteção durante os treinos.',
    price: 24.90,
    category: mockCategories[1], // Equipamentos
    type: mockTypes[0], // Proteção
    images: [
  ...
  },
  {
    ...
    type: mockTypes[2], // Vestuário
    images: [
      'https://images.pexels.com/photos/8844895/pexels-photo-8844895.jpeg'
    ],
    inStock: true,
    stockQuantity: 30,
    sizes: ['P', 'M', 'G', 'GG'],
  ...
  },
  {
    ...
    description: 'Guia completo com técnicas fundamentais e avançadas do Krav Maga.',
    price: 59.90,
  ...
  },
  {
    ...
    description: 'Suplemento proteico para auxiliar no desenvolvimento muscular.',
    price: 89.90,
  ...
  },
  {
    ...
    type: mockTypes[0], // Proteção
    images: [
      'https://images.pexels.com/photos/6975421/pexels-photo-6975421.jpeg'
    ],
    inStock: true,
    stockQuantity: 40,
